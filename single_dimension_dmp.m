...
start     = 1;          % DMP start-position
goal      = 2;          % DMP end-position
...
T=zeros(floor(2*tau/dt+1),3);           % trajectory (user-specified)
Y=T;                                    % dmp-computed trajectory
PSI=zeros(floor(2*tau/dt+1),n_rfs);     % storage for gaussians
